...
public class Employee extends FXModel {
    ...
    public Employee(String emp_id, String name, Job job, Employee manager, LocalDate hire_date, Long salary, Long commission, Department department ){
    ...
    public FXModel clone() {
        Employee employee = new Employee(getEmpId(), getName(), getJob(), getManager(), getHireDate(), getSalary(), getCommision(), getDepartment());
        if (getManager()!=null)
